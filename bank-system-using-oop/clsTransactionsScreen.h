...
private:
    enum enTransactionsMenueOptions {
        ...
        eShowTotalBalance = 3, eTransfer = 4,eShowTransferLogList=5, eShowMainMenue = 6
    };
    ...
    static void _ShowTranferLogListScreen()
    {
...
public:
    ...
    static void ShowTransactionsMenue()
    {
        ...
        cout << setw(37) << left << "" << "\t[5] Show Transfer log list.\n";
